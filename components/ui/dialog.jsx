  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 flex flex-col w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-6 rounded-2xl border p-6 shadow-lg duration-200 sm:max-w-md",
          className
        )}
        {...props}>
        {children}
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn("flex gap-2 justify-end -mb-2 -mr-2", className)}
      {...props} />
  );
}
